...
def update_results(model_name,model_size,batchsize,lambda_memory,inference_mean, inference_median,inf_time_list,running_time):
    ...
    s3_client.upload_file(f'/tmp/{model_name}_{model_size}_{batchsize}_{lambda_memory}_inference.json',BUCKET_NAME,f'results/onnx/arm/inference/{model_name}_{model_size}_{batchsize}_{lambda_memory}_inference.json')
